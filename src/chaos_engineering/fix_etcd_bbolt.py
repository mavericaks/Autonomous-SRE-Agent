...
cmd = """
sudo wget -O /tmp/bbolt https://github.com/etcd-io/bbolt/releases/download/v1.3.11/bbolt-linux-amd64
sudo chmod +x /tmp/bbolt
sudo systemctl stop kubelet
sudo crictl stop $(sudo crictl ps -a --name etcd -q)
sudo mv /var/lib/etcd/member/snap/db /var/lib/etcd/member/snap/db.corrupt
sudo /tmp/bbolt compact -o /var/lib/etcd/member/snap/db /var/lib/etcd/member/snap/db.corrupt
