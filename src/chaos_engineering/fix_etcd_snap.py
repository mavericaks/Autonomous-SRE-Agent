...
# Move out any .snap files. Keep db and wal.
sudo mkdir -p /var/lib/etcd/member/snap/backup
sudo mv /var/lib/etcd/member/snap/*.snap /var/lib/etcd/member/snap/backup/ 2>/dev/null
