...
print("Patching imagePullPolicy to IfNotPresent...")
patch_cmd = """kubectl patch deployment video-streaming-server -p '{"spec": {"template": {"spec": {"containers": [{"name": "nginx-rtmp", "imagePullPolicy": "IfNotPresent"}]}}}}'"""
